...
const Header = ({ decreaseFontSize, increaseFontSize }) => {
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center mt-8 relative gap-2.5">
          <div className="flex justify-between sm:justify-end w-full gap-3 sm:absolute right-[34px] px-5">
            <button
              ...
              className="text-[#740000] text-3xl border border-black rounded-lg sm:rounded-xl w-8 h-8 sm:w-11 sm:h-11 flex justify-center items-center"
            >
              +
            </button>
            <button
